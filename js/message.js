function traerInformacion() {
    ...
    $.ajax({
        url: "https://g54aebbad8caaba-ejhm8wk1ink77ulw.adb.sa-saopaulo-1.oraclecloudapps.com/ords/admin/message/message",
        type: "GET",
        datatype: "JSON",
...
function editarElemento(idElemento) {
    ...
    $.ajax({
        url: "https://g54aebbad8caaba-ejhm8wk1ink77ulw.adb.sa-saopaulo-1.oraclecloudapps.com/ords/admin/message/message/"+idElemento,
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
